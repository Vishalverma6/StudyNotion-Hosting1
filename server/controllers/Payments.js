...
exports.capturePayment = async(req,res) => {
    ...
    for(const course_id of courses){
        ...
        try{
            ...
            // kahi student pahle se hi enrolled toh nhi hai
...
exports.sendPaymentSuccessEmail =async(req,res)=> {
    ...
    try{
        ...
        console.log("Error in sending email fo successfull payment ",error);
        return res.status(500).jso({
            success:false,
            message: "Could not send email of successfull payment ",
        })
    }
...
//             return res.status(401).json({
//                 success:false,
//                 message:"Student is already enrolle dfor the course",
//             });
//         }
//     }
//     catch(error){
...
//         return res.status(200).json({
//             success:true,
//             message:"Payment oredre initiate ",
...
//             // find the student and add the course in their enrolled course list 
...
//             // email send kardo confimation ke liye 
//             const emailResponse= await mailSender(
//                                            enrolledStudent.email,
//                                            "congratulations",
