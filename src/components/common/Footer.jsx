...
const Footer = () => {
  return (
    <div className='bg-richblack-800 '>
        <div className='w-11/12 flex flex-col mx-auto text-[12px] text-richblack-300 items-center px-32 py-10 '>
              {/* upper part */}
            <div className='flex w-full flex-row  gap-5 border-b-2 border-richblack-700 pb-7 mb-5 '>
                {/* right part */}
                <div className='flex ml-10 gap-x-7  justify-between w-[50%]  '>
                ...
                {/* Left Part */}
                <div className='flex justify-between  gap-x-12 border-l-2 pl-7 border-richblack-700'>
                    <div className='flex flex-col gap-3 '>
            ...
            <div className='flex w-full flex-row justify-between items-center 
             mt-14'>
                ...
                <div className='flex items-center gap-2 '>
                    ...
                    <p> 
                        CodeHelp &copy; 2023 StudyNotion  
                    </p>
                </div>
