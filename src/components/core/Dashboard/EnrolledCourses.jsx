...
const EnrolledCourses = () => {
  ...
  return (
    <div className='text-white w-11/12 flex flex-col gap-10'>
             ...
             {/* yahan se Card shuru hot hain */}
             {
              enrolledCourses.map((course,index, arr)=> (
                ...
                >
                    ...
                    <div className='w-1/4 px-2 py-3 text-yellow-200'>
                    ...
                    <div className='flex flex-col w-1/5 gap-2 px-2 py-3'>
                       <p>
                        Progress: {"  "}
                        <span className='text-yellow-200'>{course?.progressPercentage || 0}% </span>
                       </p>
                       <ProgressBar
